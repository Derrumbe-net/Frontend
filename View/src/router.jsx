...
const router = createBrowserRouter([
	// Main webpage routes
	{
		...
		children: [
			...
			{
				path: "mapa-susceptibilidad-municipios",
				element: <SusceptibilityMunicipalitiesMap />,
			},
			{ path: "reportar", element: <Report /> },
			{ path: "solicitud", element: <Request /> },
			{
				path: "landslideready-individuos",
				element: <LandslideReadyPR_Individuos />,
			},
			{
				path: "landslideready-municipios",
				element: <LandslideReadyPR_Municipios />,
			},
		],
	},
